app.controller('heladeriaController', function ($scope,ngTableParams,$filter,inicioService) {
    ...
    function loadMateria(){
        ...
        var promiseGet = inicioService.getMateriaheladeria(); //The Method Call from service
    ...
    function loadAdicionales(){
        ...
        var promiseGet = inicioService.getAdicionalesheladeria(); //The Method Call from service
